...
class main_window():
    ...
    def main_page(self):
       ...
       #main_page_frame_view3_patient_registration_default_frame------start------------- 
        ...
        self.patient_queue_doctor_value_update()
...
doctor_name
        ...
        self.opd_queue_button_reload=tk.Button(self.main_page_frame_view3_opd_queue_default_frame,text="Reload queue",command=self.opd_queue_reload_button)
        ...
        self.opd_queue_doctor_value_update()
        self.opd_queue_role_entry = ttk.OptionMenu(self.main_page_frame_view3_opd_queue_default_frame,self.opd_queue_value_inside , *self.opd_queue_roles_list)
        ...
        # define columns
        self.opd_queue_columns = ('patinet_ID', 'First_name','Queue_Type','Queue_Status','Reason','Doctor_name','doctor_Id')
        ...
        # define headings
        self.opd_queue_default_tree.heading('patinet_ID', text='patinet ID')
        self.opd_queue_default_tree.heading('First_name', text='First name')
        self.opd_queue_default_tree.heading('Queue_Type', text='Queue Type')
        self.opd_queue_default_tree.heading('Queue_Status', text='Queue Status')
        self.opd_queue_default_tree.heading('Reason', text='Reason')
        self.opd_queue_default_tree.heading('Doctor_name', text='Doctor name')
        self.opd_queue_default_tree.heading('doctor_Id', text='doctor Id')
        #patient_search_tree_view========================================end========================================
    ...
    def patient_queue_doctor_value_update(self):
          ...
          for i in self.patient_queue_doctor_list_update_command:
              ...
              self.patient_queue_roles_list.append(i)
    ...
    def patient_queue_send_to_OPD_doctor_value_update(self):
          ...
          for i in self.patient_queue_doctor_list_update_command:
              ...
              self.patient_queue_send_to_OPD_doctor_list.append(i)
              print("self.patient_queue_send_to_OPD_doctor_list:",self.patient_queue_send_to_OPD_doctor_list)
    ...
    def  patient_queue_send_to_OPD_fun(self):
        ...
        self.patient_queue_send_to_OPD_button2_refresh.place(x=220,y=150,width=25,height=25)
        """

        self.patient_queue_send_to_OPD_doctor_label=tk.Label(self.patient_queue_send_to_OPD,text="Doctor ")
        self.patient_queue_send_to_OPD_doctor_label.place(x=20,y=150,width=100,height=15)
        ...
        self.patient_queue_send_to_OPD_doctor_list = []
        self.patient_queue_send_to_OPD_doctor_value_update()
        ...
        self.patient_queue_send_to_OPD_doctor.place(x=170,y=150)
        ...
        self.patient_queue_send_to_OPD_yes_button=tk.Button(self.patient_queue_send_to_OPD,text="YES",command=self.patient_queue_send_to_OPD_yes_button_values_update)
    ...
    def  patient_queue_send_to_ipd_fun(self):
        ...
        self.patient_queue_send_to_ipd_doctor_label.place(x=20,y=140,width=100,height=15)
        ...
        self.patient_queue_send_to_ipd_doctor_list = []
        self.patient_queue_send_to_ipd_doctor_value_update()
        ...
        self.patient_queue_send_to_ipd_doctor.place(x=170,y=140)
        ...
        self.patient_queue_send_to_ipd_warning_label.place(x=70,y=180,width=400,height=15)

        self.patient_queue_send_to_ipd_yes_button=tk.Button(self.patient_queue_send_to_ipd,text="YES",command=self.patient_queue_send_to_ipd_yes_button_update)
    ...
    def opd_queue_reload_button(self):
        self.opd_queue_display_treeview_reset()
        ...
        for i in self.opd_queue_display_sql_command_execution:
            self.opd_queue_contacts.append((f'{i[0]}', f'{i[1]}', f'{i[2]}',f'{i[3]}',f'{i[4]}', f'{i[5]}',f'{i[6]}'))
    ...
    def opd_queue_doctor_value_update(self):
          ...
          for i in self.opd_queue_doctor_list_update_command:
              ...
              self.opd_queue_roles_list.append(i)
    ...
    def  opd_queue_send_to_IPD_fun(self):
        ...
        self.opd_queue_send_to_IPD = Toplevel(self.main_page_frame_view3_opd_queue_default_frame)
        self.opd_queue_send_to_IPD.title("SEND TO IPD")
        self.opd_queue_send_to_IPD.geometry("600x250+500+300")
        self.opd_queue_selectItem()
        self.opd_queue_send_to_ipd_id_label_display_var = StringVar()
        self.opd_queue_send_to_ipd_id_label_display_var.set("None1")
        self.opd_queue_send_to_ipd_name_label_display_var = "None"
        self.opd_queue_send_to_ipd_phoneno_label_display_var = "None"
        self.opd_queue_send_to_ipd_gender_label_display_var = "None"
        self.opd_queue_send_to_ipd_age_label_display_var = "None"
        if(self.opd_queue_selected == ''):
            pass
        else:
            self.opd_queue_send_to_ipd_treeview_select_responce= self.opd_queue_default_tree.focus()
            print("opd_queue_send_to_ipd_treeview_selected :",self.opd_queue_send_to_ipd_treeview_select_responce)
            self.opd_queue_send_to_ipd_treeview_selected1 = self.opd_queue_default_tree.item(self.opd_queue_send_to_ipd_treeview_select_responce)
            ...
            print("str(self.opd_queue_send_to_ipd_values_update_command[0][0])",str(self.opd_queue_send_to_ipd_values_update_command[0][0]))
            self.opd_queue_send_to_ipd_name_label_display_var=str(self.opd_queue_send_to_ipd_values_update_command[0][1])
            self.opd_queue_send_to_ipd_phoneno_label_display_var=str(self.opd_queue_send_to_ipd_values_update_command[0][2])
            self.opd_queue_send_to_ipd_gender_label_display_var=str(self.opd_queue_send_to_ipd_values_update_command[0][3])
            self.opd_queue_send_to_ipd_age_label_display_var=str(self.opd_queue_send_to_ipd_values_update_command[0][4])
            #self. =self.opd_queue_send_to_ipd_treeview_selected[1]
            #self. =self.opd_queue_send_to_ipd_treeview_selected[2]
            

        self.opd_queue_send_to_IPD_id_label=tk.Label(self.opd_queue_send_to_IPD,text="Patient ID :")
        self.opd_queue_send_to_IPD_id_label.place(x=20,y=20,width=100,height=15)
        self.opd_queue_send_to_IPD_id_label_display=tk.Label(self.opd_queue_send_to_IPD,text=self.opd_queue_send_to_ipd_id_label_display_var.get())
        self.opd_queue_send_to_IPD_id_label_display.place(x=172,y=20,width=112,height=15)

        self.opd_queue_send_to_IPD_name_label=tk.Label(self.opd_queue_send_to_IPD,text="Name :")
        self.opd_queue_send_to_IPD_name_label.place(x=300,y=20,width=102,height=15)
        self.opd_queue_send_to_IPD_name_label_display=tk.Label(self.opd_queue_send_to_IPD,text=self.opd_queue_send_to_ipd_name_label_display_var)
        self.opd_queue_send_to_IPD_name_label_display.place(x=424,y=20,width=112,height=15)
        
        self.opd_queue_send_to_IPD_phoneno_label=tk.Label(self.opd_queue_send_to_IPD,text="Phone NO :")
        self.opd_queue_send_to_IPD_phoneno_label.place(x=20,y=60,width=100,height=15)
        self.opd_queue_send_to_OPD_phoneno_label_display=tk.Label(self.opd_queue_send_to_IPD,text=self.opd_queue_send_to_ipd_phoneno_label_display_var)
        self.opd_queue_send_to_OPD_phoneno_label_display.place(x=172,y=60,width=112,height=15)
        
        self.opd_queue_send_to_IPD_gender_label=tk.Label(self.opd_queue_send_to_IPD,text="Gender:")
        self.opd_queue_send_to_IPD_gender_label.place(x=300,y=60,width=100,height=15)
        self.opd_queue_send_to_IPD_gender_label_display=tk.Label(self.opd_queue_send_to_IPD,text=self.opd_queue_send_to_ipd_gender_label_display_var)
        self.opd_queue_send_to_IPD_gender_label_display.place(x=424,y=60,width=112,height=15)

        self.opd_queue_send_to_IPD_age_label=tk.Label(self.opd_queue_send_to_IPD,text="Age :")
        self.opd_queue_send_to_IPD_age_label.place(x=20,y=100,width=100,height=15)
        self.opd_queue_send_to_IPD_age_label_display=tk.Label(self.opd_queue_send_to_IPD,text=self.opd_queue_send_to_ipd_age_label_display_var)
        self.opd_queue_send_to_IPD_age_label_display.place(x=172,y=100,width=112,height=15)
        
        self.opd_queue_send_to_IPD_doctor_label=tk.Label(self.opd_queue_send_to_IPD,text="Doctor ")
        self.opd_queue_send_to_IPD_doctor_label.place(x=20,y=140,width=100,height=15)
        self.opd_queue_send_to_IPD_doctor_value_inside=tk.StringVar()
        self.opd_queue_send_to_IPD_doctor_value_inside.set('select role')
        self.opd_queue_send_to_IPD_doctor_list = []
        self.opd_queue_send_to_IPD_doctor_value_update()
        self.opd_queue_send_to_IPD_doctor= ttk.OptionMenu(self.opd_queue_send_to_IPD,self.opd_queue_send_to_IPD_doctor_value_inside , *self.opd_queue_send_to_IPD_doctor_list)
        self.opd_queue_send_to_IPD_doctor.configure(width=38)
        self.opd_queue_send_to_IPD_doctor.place(x=170,y=140)
        print("the valuse on the roles:",self.opd_queue_send_to_IPD_doctor_value_inside.get())

        self.opd_queue_send_to_IPD_warning_label=tk.Label(self.opd_queue_send_to_IPD,text=" ",font=('calibre',13,'bold'))
        self.opd_queue_send_to_IPD_warning_label.place(x=70,y=180,width=400,height=15)

        self.opd_queue_send_to_IPD_yes_button=tk.Button(self.opd_queue_send_to_IPD,text="YES",command=self.opd_queue_send_to_OPD_yes_button_update)
        self.opd_queue_send_to_IPD_yes_button.pack_forget()
        self.opd_queue_send_to_IPD_no_button=tk.Button(self.opd_queue_send_to_IPD,text="NO",command=self.opd_queue_send_to_IPD_deactivate)
        self.opd_queue_send_to_IPD_no_button.pack_forget()


        if(self.opd_queue_selected == ''):
            self.opd_queue_send_to_IPD_warning_label.config(text="WARNING!:please select patient in patient queue")
        else:
            self.opd_queue_send_to_IPD_yes_button.place(x=70,y=220,width=112,height=25)
            self.opd_queue_send_to_IPD_no_button.place(x=370,y=220,width=112,height=25)
    ...
    def opd_queue_send_to_IPD_doctor_value_update(self):
        ...
        for i in self.opd_queue_doctor_list_update_command:
              ...
              self.opd_queue_send_to_IPD_doctor_list.append(i)
              print("self.patient_queue_send_to_OPD_doctor_list:",self.opd_queue_send_to_IPD_doctor_list)
    def opd_queue_send_to_OPD_yes_button_update(self):
        ...
        if self.opd_queue_send_to_IPD_yes_button_update_doc_name == "('ashok',)":
            self.opd_queue_send_to_IPD_yes_button_update_doc_name = self.opd_queue_send_to_IPD_yes_button_update_doc_name[2:len(self.opd_queue_send_to_IPD_yes_button_update_doc_name)-3]
            print("self.opd_queue_send_to_OPD_yes_button_update_doc_name[2:len(self.opd_queue_send_to_OPD_yes_button_update_doc_name)-3]:",self.opd_queue_send_to_IPD_yes_button_update_doc_name[2:len(self.opd_queue_send_to_IPD_yes_button_update_doc_name)-3])
        else:
    ...
    def  opd_queue_completed_fun(self):
        ...
        self.opd_queue_completed_page_id_label_display_var = StringVar()
        self.opd_queue_completed_page_id_label_display_var.set("None1")
        self.opd_queue_completed_page_name_label_display_var = "None"
        self.opd_queue_completed_page_phoneno_label_display_var = "None"
        self.opd_queue_completed_page_gender_label_display_var = "None"
        self.opd_queue_completed_page_age_label_display_var = "None"
        if(self.opd_queue_selected == ''):
            pass
        else:
            self.opd_queue_completed_page_treeview_select_responce= self.opd_queue_default_tree.focus()
            print("opd_queue_completed_page_treeview_selected :",self.opd_queue_completed_page_treeview_select_responce)
            self.opd_queue_completed_page_treeview_selected1 = self.opd_queue_default_tree.item(self.opd_queue_completed_page_treeview_select_responce)
            ...
            print("str(self.opd_queue_completed_page_values_update_command[0][0])",str(self.opd_queue_completed_page_values_update_command[0][0]))
            self.opd_queue_completed_page_name_label_display_var=str(self.opd_queue_completed_page_values_update_command[0][1])
            self.opd_queue_completed_page_phoneno_label_display_var=str(self.opd_queue_completed_page_values_update_command[0][2])
            self.opd_queue_completed_page_gender_label_display_var=str(self.opd_queue_completed_page_values_update_command[0][3])
            self.opd_queue_completed_page_age_label_display_var=str(self.opd_queue_completed_page_values_update_command[0][4])
            #self. =self.opd_queue_completed_page_treeview_selected[1]
            #self. =self.opd_queue_completed_page_treeview_selected[2]
        ...
        self.opd_queue_completed_id_label_display=tk.Label(self.opd_queue_completed,text=self.opd_queue_completed_page_id_label_display_var.get())
        ...
        self.opd_queue_completed_name_label_display=tk.Label(self.opd_queue_completed,text=self.opd_queue_completed_page_name_label_display_var)
        ...
        self.opd_queue_completed_phoneno_label_display=tk.Label(self.opd_queue_completed,text=self.opd_queue_completed_page_phoneno_label_display_var)
        ...
        self.opd_queue_completed_gender_label_display=tk.Label(self.opd_queue_completed,text=self.opd_queue_completed_page_gender_label_display_var)
        ...
        self.opd_queue_completed_age_label_display=tk.Label(self.opd_queue_completed,text=self.opd_queue_completed_page_age_label_display_var)
        ...
        self.opd_queue_completed_yes_button=tk.Button(self.opd_queue_completed,text="YES",command=self.opd_queue_completed_page_yes_button_update)
    ...
    def  opd_queue_delete_fun(self):
        self.opd_queue_selectItem()
        self.opd_queue_Delete_page = Toplevel(self.main_page_frame_view3_opd_queue_default_frame)
        self.opd_queue_Delete_page.title("DELETE FROM opd QUEUE")
        self.main_window_geometry_x = self.root1.winfo_x()
        self.main_window_geometry_y = self.root1.winfo_y()
        self.opd_queue_Delete_page.geometry("600x205+500+300")
        
        self.opd_queue_Delete_page_id_label_display_var = StringVar()
        self.opd_queue_Delete_page_id_label_display_var.set("None1")
        self.opd_queue_Delete_page_name_label_display_var = "None"
        self.opd_queue_Delete_page_phoneno_label_display_var = "None"
        self.opd_queue_Delete_page_gender_label_display_var = "None"
        self.opd_queue_Delete_page_age_label_display_var = "None"
        if(self.opd_queue_selected == ''):
            pass
        else:
            self.opd_queue_Delete_page_treeview_select_responce= self.opd_queue_default_tree.focus()
            print("opd_queue_Delete_page_treeview_selected :",self.opd_queue_Delete_page_treeview_select_responce)
            self.opd_queue_Delete_page_treeview_selected1 = self.opd_queue_default_tree.item(self.opd_queue_Delete_page_treeview_select_responce)
            ...
            print("str(self.opd_queue_Delete_page_values_update_command[0][0])",str(self.opd_queue_Delete_page_values_update_command[0][0]))
            self.opd_queue_Delete_page_name_label_display_var=str(self.opd_queue_Delete_page_values_update_command[0][1])
            self.opd_queue_Delete_page_phoneno_label_display_var=str(self.opd_queue_Delete_page_values_update_command[0][2])
            self.opd_queue_Delete_page_gender_label_display_var=str(self.opd_queue_Delete_page_values_update_command[0][3])
            self.opd_queue_Delete_page_age_label_display_var=str(self.opd_queue_Delete_page_values_update_command[0][4])
            #self. =self.opd_queue_Delete_page_treeview_selected[1]
            #self. =self.opd_queue_Delete_page_treeview_selected[2]

        
        self.opd_queue_Delete_page_label=tk.Label(self.opd_queue_Delete_page,text="Patient ID :")
        self.opd_queue_Delete_page_label.place(x=20,y=20,width=100,height=15)
        self.opd_queue_Delete_page_label_display=tk.Label(self.opd_queue_Delete_page,text=self.opd_queue_Delete_page_id_label_display_var.get())
        self.opd_queue_Delete_page_label_display.place(x=172,y=20,width=112,height=15)

        self.opd_queue_Delete_page_name_label=tk.Label(self.opd_queue_Delete_page,text="Name :")
        self.opd_queue_Delete_page_name_label.place(x=300,y=20,width=102,height=15)
        self.opd_queue_Delete_page_name_label_display=tk.Label(self.opd_queue_Delete_page,text=self.opd_queue_Delete_page_name_label_display_var)
        self.opd_queue_Delete_page_name_label_display.place(x=424,y=20,width=112,height=15)
        
        self.opd_queue_Delete_page_phoneno_label=tk.Label(self.opd_queue_Delete_page,text="Phone NO :")
        self.opd_queue_Delete_page_phoneno_label.place(x=20,y=60,width=100,height=15)
        self.opd_queue_Delete_page_phoneno_label_display=tk.Label(self.opd_queue_Delete_page,text=self.opd_queue_Delete_page_phoneno_label_display_var)
        self.opd_queue_Delete_page_phoneno_label_display.place(x=172,y=60,width=112,height=15)
        
        self.opd_queue_Delete_page_gender_label=tk.Label(self.opd_queue_Delete_page,text="Gender:")
        self.opd_queue_Delete_page_gender_label.place(x=300,y=60,width=100,height=15)
        self.opd_queue_Delete_page_gender_label_display=tk.Label(self.opd_queue_Delete_page,text=self.opd_queue_Delete_page_gender_label_display_var)
        self.opd_queue_Delete_page_gender_label_display.place(x=424,y=60,width=112,height=15)

        self.opd_queue_Delete_page_age_label=tk.Label(self.opd_queue_Delete_page,text="Age :")
        self.opd_queue_Delete_page_age_label.place(x=20,y=100,width=100,height=15)
        self.opd_queue_Delete_page_age_label_display=tk.Label(self.opd_queue_Delete_page,text=self.opd_queue_Delete_page_age_label_display_var)
        self.opd_queue_Delete_page_age_label_display.place(x=172,y=100,width=112,height=15)
        
        self.opd_queue_Delete_page_warning_label=tk.Label(self.opd_queue_Delete_page,text=" ",font=('calibre',13,'bold'))
        self.opd_queue_Delete_page_warning_label.place(x=70,y=130,width=400,height=15)

        

        
        self.opd_queue_Delete_page_yes_button=tk.Button(self.opd_queue_Delete_page,text="YES",command=self.opd_queue_Delete_page_yes_button_update)
        self.opd_queue_Delete_page_yes_button.pack_forget()
        self.opd_queue_Delete_page_no_button=tk.Button(self.opd_queue_Delete_page,text="NO",command=self.opd_queue_Delete_page_deactivate)
        self.opd_queue_Delete_page_no_button.pack_forget()

        if(self.opd_queue_selected == ''):
            self.opd_queue_Delete_page_warning_label.config(text="WARNING!:please select opd in opd queue")
        else:
            self.opd_queue_Delete_page_warning_label.config(text="Do you want to detele from opd queue")
            #self.opd_queue_Delete_page_yes_button = tk.Button(self.opd_queue_Delete_page,text="YES",font=('calibre',20,'bold'))
            self.opd_queue_Delete_page_yes_button.place(x=70,y=170,width=112,height=25)
            #self.opd_queue_Delete_page_no_button = tk.Button(self.opd_queue_Delete_page,text="NO",font=('calibre',20,'bold'))
            self.opd_queue_Delete_page_no_button.place(x=370,y=170,width=112,height=25)
    ...
    def opd_queue_Delete_page_deactivate(self):
        self.opd_queue_Delete_page.destroy()
