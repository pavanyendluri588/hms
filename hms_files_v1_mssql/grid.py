...
class main_window():
    ...
    def login_check_fun(self):
              ...
              #self.response = 'true'
              print("login check from  responce :-",self.response)
              if self.response == 'true':
                       #return  self.response
                       self.login_page_frame1.pack_forget()
    ...
    def main_page(self):
        ...
        self.main_page_frame_view3_home_image =Image.open("g:/hms_v1/hms_files_v1_mssql/main_page_home.jpeg")
        # Show image using label
       ...
       #main_page_frame_view3_patient_registration_default_frame------start------------- 
        ...
        self.main_page_frame_view3_physical_management_room_status_line_label= tk.Label(self.main_page_frame_view3_physical_management_room_status_frame,text="",bg='black')
        self.main_page_frame_view3_physical_management_room_status_line_label.place(x=5,y=85,width=1285,height=1)

        self.main_page_frame_view3_physical_management_room_status_Refresh = tk.Button(self.main_page_frame_view3_physical_management_room_status_frame,text="Refresh",command= self.physical_management_room_status_refresh)
        self.main_page_frame_view3_physical_management_room_status_Refresh.place(x=20,y=90,width=100,height=30)
